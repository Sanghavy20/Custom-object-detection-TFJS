...
async function load_model() {
    ...
    const model = await loadGraphModel ("https://raw.githubusercontent.com/Sanghavy20/Custom-object-detection-TFJS/main/models/club-ball-detector/model.json");
    return model;
  }
...
class App extends React.Component {
  ...
  render() {
    return (
      <div>
        <h1>Real-Time Object Detection: Club-Ball</h1>
        <h3>MobileNetV2</h3>
        <video
